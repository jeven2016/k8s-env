	...
	function Keycloak (config) {
	                    ...
	                    if (loginIframe.enable) {
	                        setupCheckLoginIframe().then(function() {
	                            checkLoginIframe().then(function (unchanged) {
																// console.log(unchanged, 'unchange===>')
	    ...
	    function processCallback(oauth, promise) {
	        ...
	        function authSuccess(accessToken, refreshToken, idToken, fulfillPromise) {
						// debugger
						const kk = JSON.parse(JSON.stringify(kc))
						// console.log('_kc===>', kk)
	    ...
	    function setupCheckLoginIframe() {
	        var promise = createPromise();
					// console.log(loginIframe, 'loginIframe==>')
					// debugger
	        ...
	        loginIframe.iframe = iframe;
					// const url = kc.endpoints.authorize()
					// console.log(url, ' kc.endpoints.authorize()===>	')
	        ...
	        var messageCallback = function(event) {
	            ...
	            var callbacks = loginIframe.callbackList.splice(0, loginIframe.callbackList.length);
							...
							// console.log(callbacks, 'call-===>', event.data)
							// // debugger
	            ...
	            var messageCallback = function(event) {
	                if (iframe.contentWindow !== event.source) {
	                    return;
									...
									console.log(event.data, 'check3pCookiesSupported===>')
